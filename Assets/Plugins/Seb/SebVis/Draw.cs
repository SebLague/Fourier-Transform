...
namespace Seb.Vis
{
    ...
    public static partial class Draw
    {
        ...
        public static void StartLayer(Vector2 offset, float scale, bool useScreenSpace)
        {
            ...
            sphereDrawer.StartNewLayer(layerInfo);
        ...
        public static MaskScope CreateMaskScope(Vector2 maskBoundsMin, Vector2 maskBoundsMax)
        {
        ...
        {
            if (fontSize <= 0 || col.a == 0) return;

            Text.FontLoading.FontData fontData = defaultFontsData[(int)font];
        ...
        public static void Sphere(Vector3 centre, float radius, Color col)
        {
            if (radius == 0 || col.a == 0) return;

            SphereData data = new(centre, radius, col);
            sphereDrawer.AddToLayer(data);
        }
        ...
        // ------ Bounds ------
        public static Vector2 CalculateTextBoundsSize(ReadOnlySpan<char> text, float fontSize, FontType font, float lineSpacing = 1)
        {
            return CalculateTextBounds(text, font, fontSize, Vector2.zero, Anchor.Centre, lineSpacing).Size;
        }
