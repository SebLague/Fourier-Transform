...
namespace Seb.Vis.UI
{
    public class ThemeCreator
    {
        ...
        public static readonly Vector2 PaddingScaleButton = new Vector2(1.2f, 1.5f);
        ...
        static UITheme CreateTheme(FontType font, Color colBG, Color colNormal, Color colAccentBright, Color colAccentDark, Color colInactive)
        {
            ...
            return new UITheme()
            {
                ...
                inputFieldTheme = new InputFieldTheme()
                {
                    font = font,
                    fontSize = FontSizeMedium,
                    paddingScale = new Vector2(1, 1.8f),
                    bgCol = Color.white,
        ...
        static Color Darken(Color col, float darkenAmount, float desaturateAmount = 0)
        {
            return TweakHSV(col, 0, -desaturateAmount, -darkenAmount);
        }
        static Color Brighten(Color col, float brightenAmount)
        {
            return TweakHSV(col, 0, 0, brightenAmount);
        }
